...
public class ProductController {
    ...
    public ProductController(ProductService productService, AuditLogService auditLogService, IdempotencyService idempotencyService) {
    ...
    public ApiResponse<Void> adjustStock(
        ...
        requireFirstExecution(httpRequest, "product:stock-adjust", id);
