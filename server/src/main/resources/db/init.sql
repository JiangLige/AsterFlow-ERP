...
VALUES
    ('admin', '$2a$10$md2jLEI4j2Pp.LICYOp5yuzykuwsK4.r9BxqimuXQY3i94ZfWZhvW', '系统管理员', 'ADMIN', 'ACTIVE', NOW(), NOW(), 0, 0),
    ('staff', '$2a$10$hvX6aPTl56CT3Pih6GiWjO7hbVp/zIGXAWK.QZUsxwwTS.nx7xTVC', '业务员', 'STAFF', 'ACTIVE', NOW(), NOW(), 0, 0);
